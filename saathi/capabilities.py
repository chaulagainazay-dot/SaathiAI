...
def default_registry() -> CapabilityRegistry:
    ...
    for name, ver, des, blt, tst, prod in [
        ...
        ("CEO Gateway (BFF)", "1.0", True, True, True, True),
        ("Live Event Stream (SSE)", "1.0", True, True, True, True),
        ("Authentication & RBAC (Logto)", "1.0", True, True, True, False),
        ("Autonomous Content Factory", "1.0", True, True, True, False),
        ("Content Intelligence (Analytics→Learning)", "1.0", True, True, True, False),
        ("Content Knowledge Registry", "1.0", True, True, True, False),
        ("Telegram CEO Companion", "1.0", True, True, True, False),
        ("Saathi Coach (IELTS as Learn)", "1.0", True, True, True, False),
        ("IELTS Band Predictor", "1.0", True, True, True, False),
