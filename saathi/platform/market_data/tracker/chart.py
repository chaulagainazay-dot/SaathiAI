...
_STOPWORDS = {
    ...
    "ARE", "PRICES", "PRICE", "CONSISTENT", "BETWEEN", "WHICH", "TODAY", "STRONGEST",
    "HIGHEST", "STOCKS", "HAVE", "DO", "WE", "ON", "IN", "TURNOVER", "VOLUME", "SECTOR",
    "STRONG", "GAIN", "DECLINE", "MOST", "ACTIVE", "TRACKER", "NEPSE",
}
