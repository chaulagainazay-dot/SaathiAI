...
RESIDUAL_PATH_CONTROLS: tuple[ResidualPathControl, ...] = (
    ...
    ResidualPathControl(
        ...
        reason="M20.3 adopted; uses compat when rollout non-legacy",
        expiry_milestone="M21.2",
        allowed_behavior="compat adapter + optional legacy_proxy residual",
    ...
    ResidualPathControl(
        ...
        reason="Cloud wrapper; production_supported=false",
        expiry_milestone="M21.2",
        allowed_behavior="behind allow_cloud_fallback only",
    ...
    ResidualPathControl(
        ...
        expiry_milestone="M21.2",
        allowed_behavior="policy-disabled unless explicitly enabled",
    ...
    ResidualPathControl(
        ...
        module="saathi.tools.cheap_llm",
        symbol="httpx.post CHEAP_PROXY_URL",
        disposition=ResidualDisposition.DIRECT_PROVIDER_BYPASS,
        reason="Historical anthropic-proxy fallback after llm.generate failure",
        expiry_milestone="M21.2",
        allowed_behavior="existing cheap_ask only; no new callers; kill-all does not reach here when using proxy",
        telemetry_tag="legacy_proxy_bypass",
    ),
    ResidualPathControl(
