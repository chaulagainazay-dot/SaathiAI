...
RESIDUAL_PATH_CONTROLS: tuple[ResidualPathControl, ...] = (
    ...
    ResidualPathControl(
        ...
        disposition=ResidualDisposition.CANONICAL,
        reason="M24: governed cloud family adapter; wraps http_providers only; no residual exception",
        expiry_milestone="n/a",
        allowed_behavior="adapter package only; behind allow_cloud_fallback + provider decision; durable cost/circuit",
    ...
    ResidualPathControl(
        ...
        disposition=ResidualDisposition.CANONICAL,
        reason="M24: governed OpenAI-compatible transport adapter; allowlisted URLs; durable cost/circuit",
        expiry_milestone="n/a",
        allowed_behavior="adapter package only; base URL from config allowlist; SSRF protected",
        telemetry_tag="engine_compat",
        new_callers_forbidden=False,
        production_reachability=False,
    ),
    ResidualPathControl(
        path_id="durable_governance_store",
        module="saathi.inference.governance_store",
        symbol="DurableGovernanceStore",
        disposition=ResidualDisposition.CANONICAL,
        reason="M24 sole durable circuit/cost/reservation authority",
        expiry_milestone="n/a",
        allowed_behavior="governance mutations only via store/service",
        telemetry_tag="governance_store",
        new_callers_forbidden=False,
        production_reachability=True,
    ),
    ResidualPathControl(
