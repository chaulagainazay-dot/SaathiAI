...
def parse_action(action: str | BrowserAction) -> BrowserAction:
    ...
    aliases = {
        ...
        # M17.25 interactive aliases → nearest BrowserAction for gateway
        "scroll": BrowserAction.READ,
        "wait": BrowserAction.READ,
        "inspect_dom": BrowserAction.READ,
        "snapshot": BrowserAction.READ,
        "select": BrowserAction.CLICK,
        "select_option": BrowserAction.CLICK,
        "check": BrowserAction.CLICK,
        "uncheck": BrowserAction.CLICK,
        "dismiss_dialog": BrowserAction.CLICK,
        "send_message": BrowserAction.SUBMIT,
        "publish": BrowserAction.SUBMIT,
        "confirm": BrowserAction.SUBMIT,
        "accept_terms": BrowserAction.SUBMIT,
        "book": BrowserAction.SUBMIT,
        "checkout": BrowserAction.PAYMENT,
        "purchase": BrowserAction.PAYMENT,
        "trade": BrowserAction.TRADE,
        "withdrawal": BrowserAction.PAYMENT,
        "paste_clipboard": BrowserAction.FILL,
        "grant_permissions": BrowserAction.ENTER_CREDENTIALS,
    }
    if a in aliases:
        return aliases[a]
    try:
