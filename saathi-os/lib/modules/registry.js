...
export const TRADING_MODULE = defineModule({
  ...
  version: "166.0",
  description:
    "Trading Guardian research & paper foundation: strategies → regime → policy → risk → approval → paper execution. Simulation-only, long-only, localhost.",
  icon: "◈",
  category: "trading",
  status: "enabled",
  permissions: ["paper_account", "paper_order", "reconciliation", "paper_safety", "strategy", "backtest"],
  routes: [
    "/trading",
    "/trading/accounts",
    "/trading/orders",
