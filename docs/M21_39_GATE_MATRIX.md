...
| M21-G9 | Timeout and token limits explicit | UNIT | **COMPLETE** (caller + settings + descriptor bounds) |
| M21-G10 | Cost ceilings / cost metadata | UNIT | **COMPLETE WITH LIMITATIONS** (M21.2 Decimal policy; durable daily budget deferred) |
