...
| LocalModelHarness (FM-I5 design + FM-I6 impl) | deterministic-tested (mock); live **gated**; **not role-qualified**; production not authorized | `saathi/agent_runtime/harness/local_model*.py`; mock transport authoritative; loopback Ollama optional; pin `qwen2.5:1.5b`; `FM_I6_LOCAL_MODEL_HARNESS_CERTIFIED_WITH_LIMITATIONS`; `PRODUCTION_CERTIFIED=False` |
