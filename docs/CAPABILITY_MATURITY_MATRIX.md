...
| LocalModelHarness (FM-I5) | **design-only**; architecture approved with limitations | `docs/adr/ADR-LOCAL-MODEL-HARNESS.md`; `docs/agent-runtime/FM_I5_LOCAL_MODEL_HARNESS_DESIGN.md`; Ollama user-managed loopback; pin `qwen2.5:1.5b`; **no implementation**; FM-I6 gated; production not authorized |
