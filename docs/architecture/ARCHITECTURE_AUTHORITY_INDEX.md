...
| Next authorized implementation | **FM-I7 only after separate owner authorization** — FM-I6.1 closeout complete with limitations; runtime still LAN-exposed until operator rebind; commercial CLIs / production remain frozen; **FM-I7 not ready** |
...
| LocalModelHarness design | ADR-LOCAL-MODEL-HARNESS + FM-I5 design | **DESIGN_ONLY** + FM-I6 impl | `saathi/agent_runtime/harness/local_model*.py` (internal; not production) |
| LocalModelHarness implementation | FM-I6 report | **INTERNAL non-production** | mock authoritative; live gated |
