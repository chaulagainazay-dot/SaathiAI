...
- ⬜ Dependency-ordered next slices (Ajay's graph): Financial Mission Control (the *consumer* — portfolio/research/strategy/regime/new-knowledge/dream panels, built last) → Executive Intelligence integration (finance insights in the morning briefing) → **M4.5-style Integration Sprint** (verify all finance components emit standardized events, episodes flow to shared Learning Runtime, L4 governance holds everywhere, reconcile Brain.md/Wisdom.md) → tag `v0.4.0-finance`.
